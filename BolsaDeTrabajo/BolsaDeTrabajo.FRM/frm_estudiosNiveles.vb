...
Public Class frm_estudiosNiveles

#Region "FORMULARIO"
    Private Sub frm_estudiosNiveles_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub BuscarTodos()
        ...
        Dim oNivel As New cNivelesEstudios

        oDs = oNivel.BuscarTodos
    ...
    Private Sub BuscarPorID(ByVal IdNivelEstudio As Integer)


        Dim oDs As New DataSet
        Dim oNivel As New cNivelesEstudios

        oDs = oNivel.BuscarPorID(IdNivelEstudio)
        txt_id.Text = oDs.Tables(0).Rows(0).Item("IdNivelEstudio")
        ...
        Try
            If Validar() = True Then
                ...
                If Me.Estado = EstadodelFormulario.eEditar Then
                    oNivel.Modificar(txt_id.Text, txt_nombre.Text, chk_activo.Checked)
                    MsgBox("Se modificó correctamente el Nivel de Estudio con el código Nro: " + txt_id.Text, MsgBoxStyle.Information, "Exitos!")
                End If

                If Me.Estado = EstadodelFormulario.eAgregar Then
                    Dim resultado As Integer
                    resultado = oNivel.Agregar(txt_nombre.Text, chk_activo.Checked)
                    MsgBox("Se agregó correctamente el Nivel de Estudio " + txt_nombre.Text + " con el código Nro: " + resultado.ToString, MsgBoxStyle.Information, "Exitos!")
                End If
                Me.Estado = EstadodelFormulario.eConsulta
            End If
        Catch
