...
Public Class frm_conocimientosRubros
...
#Region "Formulario"
    ...
    Private Sub frm_conocimientosRubros_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub frm_conocimientosRubros_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    Private Sub frm_conocimientosRubros_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
#Region "Procedimientos"
    ...
    Private Sub BuscarTodos()
        ...
        Dim oConocimientosRubros As New cConocimientosRubros


        oDs = oConocimientosRubros.BuscarTodos
        ...
        oDs = Nothing
        oConocimientosRubros = Nothing

    End Sub

    Private Sub BuscarPorID(ByVal IdConocimientoRubro As Integer)


        Dim oDs As New DataSet
        Dim oConocimientosRubros As New cConocimientosRubros

        oDs = oConocimientosRubros.BuscarXId(IdConocimientoRubro)

        txt_id.Text = oDs.Tables(0).Rows(0).Item("IdConocimientoRubro")
        ...
        Try
            ...
            If Validar() = True Then
                ...
                If Me.Estado = EstadodelFormulario.eEditar Then
                    oConocimientosRubros.Modificar(txt_id.Text, txt_nombre.Text, chk_activo.Checked)
                ...
                If Me.Estado = EstadodelFormulario.eAgregar Then
                    ...
                    resultado = oConocimientosRubros.Agregar(txt_nombre.Text, chk_activo.Checked)
