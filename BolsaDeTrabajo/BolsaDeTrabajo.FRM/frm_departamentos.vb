...
#Region "Formulario"
    ...
    Private Sub frm_departamentos_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frm_departamentos_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Private Sub frm_departamentos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'CargarPaises()
        'CargarProvincias()
        Me.Estado = EstadodelFormulario.eConsulta
...
#Region "Procedimientos"
    ...
    Private Sub BuscarPorID(ByVal IdDepartamento As Integer)


        Dim oDs As New DataSet
        Dim oDepartamento As New cDepartamentos

        oDs = oDepartamento.BuscarXId(IdDepartamento)

        txt_id.Text = oDs.Tables(0).Rows(0).Item("IdDepartamento")
        ...
        Try
            ...
            If Validar() = True Then
                ...
                If Me.Estado = EstadodelFormulario.eEditar Then
                    oDepartamento.Modificar(txt_id.Text, txt_nombre.Text, cbo_provincia.SelectedValue, cbo_estado.SelectedValue)
                    MsgBox("Se modificó correctamente el departamento código Nro: " + txt_id.Text, MsgBoxStyle.Information, "Exitos!")
                End If

                If Me.Estado = EstadodelFormulario.eAgregar Then
                    Dim resultado As Integer
                    resultado = oDepartamento.Agregar(txt_nombre.Text, cbo_provincia.SelectedValue, cbo_estado.SelectedValue)
                    MsgBox("Se agregó correctamente el departamento " + txt_nombre.Text + " con el código Nro: " + resultado.ToString, MsgBoxStyle.Information, "Exitos!")
                End If
...
#Region "Funciones"
    ...
    Private Function Validar() As Boolean
        ...
        If txt_nombre.Text = "" Then
            ...
            MsgBox("Complete el nombre del departamento", MsgBoxStyle.Exclamation, "Mensaje")
            Return False
