...
Public Class frm_puestosLaborales

#Region "FORMULARIO"
    Private Sub frm_puestosLaborales_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub BuscarPorID(ByVal IdPuestoLaboral As Integer)


        Dim oDs As New DataSet
        Dim oPuesto As New cPuestosLaborales

        oDs = oPuesto.BuscarPorID(IdPuestoLaboral)
        txt_id.Text = oDs.Tables(0).Rows(0).Item("IdPuestoLaboral")
        ...
        Try
            If Validar() = True Then
                ...
                If Me.Estado = EstadodelFormulario.eEditar Then
                    oPuesto.Modificar(txt_id.Text, txt_nombre.Text, chk_activo.Checked)
                    MsgBox("Se modificó correctamente el Puesto con el código Nro: " + txt_id.Text, MsgBoxStyle.Information, "Exitos!")
                End If

                If Me.Estado = EstadodelFormulario.eAgregar Then
                    Dim resultado As Integer
                    resultado = oPuesto.Agregar(txt_nombre.Text, chk_activo.Checked)
                    MsgBox("Se agregó correctamente el Puesto " + txt_nombre.Text + " con el código Nro: " + resultado.ToString, MsgBoxStyle.Information, "Exitos!")
                End If
                Me.Estado = EstadodelFormulario.eConsulta
            End If
        Catch
