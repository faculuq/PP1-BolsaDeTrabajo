...
Public Class frm_conocimientosTipos
...
#Region "Formulario"
    ...
    Private Sub frm_conocimientosTipos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
#Region "Procedimientos"
    ...
    Private Sub BuscarTodos()
        ...
        Dim oConocimientoTipo As New cConocimientosTipos

        oDs = oConocimientoTipo.BuscarTodos
        ...
        oDs = Nothing
        oConocimientoTipo = Nothing

    End Sub

    Private Sub BuscarPorID(ByVal IdConocimientoTipo As Integer)


        Dim oDs As New DataSet
        Dim oConocimientoTipo As New cConocimientosTipos

        oDs = oConocimientoTipo.BuscarXId(IdConocimientoTipo)

        txt_id.Text = oDs.Tables(0).Rows(0).Item("IdConocimientoTipo")
        txt_nombre.Text = oDs.Tables(0).Rows(0).Item("Nombre")
        cbo_rubro.SelectedValue = oDs.Tables(0).Rows(0).Item("IdConocimientoRubro")
    ...
    Private Sub CargarRubros()
        ...
        oDs = oConocimientoTipo.BuscarRubros
        ...
        Try
            ...
            If Validar() = True Then
                ...
                If Me.Estado = EstadodelFormulario.eEditar Then
                    oConocimientoTipo.Modificar(txt_id.Text, txt_nombre.Text, cbo_rubro.SelectedValue, chk_activo.Checked)
                    MsgBox("Se modificó correctamente el Tipo de Conocimiento código Nro: " + txt_id.Text, MsgBoxStyle.Information, "Exitos!")
                End If

                If Me.Estado = EstadodelFormulario.eAgregar Then
                    Dim resultado As Integer
                    resultado = oConocimientoTipo.Agregar(txt_nombre.Text, cbo_rubro.SelectedValue, chk_activo.Checked)
                    MsgBox("Se agregó correctamente el Tipo de Conocimiento " + txt_nombre.Text + " con el código Nro: " + resultado.ToString, MsgBoxStyle.Information, "Exitos!")
                End If
...
#Region "Funciones"
    ...
    Private Function Validar() As Boolean
        ...
        If txt_nombre.Text = "" Then
            ...
            MsgBox("Complete el nombre del tipo de Conocimiento", MsgBoxStyle.Exclamation, "Mensaje")
            Return False
