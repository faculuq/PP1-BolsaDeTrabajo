...
Public Class frm_situacionesLaborales

#Region "FORMULARIO"
    Private Sub frm_situacionesLaborales_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub BuscarTodos()
        ...
        Dim oSituacion As New cSituacionesLaborales

        oDs = oSituacion.BuscarTodos
    ...
    Private Sub BuscarPorID(ByVal IdSituacionLaboral As Integer)


        Dim oDs As New DataSet
        Dim oSituacion As New cSituacionesLaborales

        oDs = oSituacion.BuscarPorID(IdSituacionLaboral)
        txt_id.Text = oDs.Tables(0).Rows(0).Item("IdSituacionLaboral")
        ...
        Try
            If Validar() = True Then
                ...
                If Me.Estado = EstadodelFormulario.eEditar Then
                    oSituacion.Modificar(txt_id.Text, txt_nombre.Text, chk_activo.Checked)
                    MsgBox("Se modificó correctamente la Situacion Laboral con el código Nro: " + txt_id.Text, MsgBoxStyle.Information, "Exitos!")
                End If

                If Me.Estado = EstadodelFormulario.eAgregar Then
                    Dim resultado As Integer
                    resultado = oSituacion.Agregar(txt_nombre.Text, chk_activo.Checked)
                    MsgBox("Se agregó correctamente la Situacion Laboral " + txt_nombre.Text + " con el código Nro: " + resultado.ToString, MsgBoxStyle.Information, "Exitos!")
                End If
                Me.Estado = EstadodelFormulario.eConsulta
            End If
        Catch
