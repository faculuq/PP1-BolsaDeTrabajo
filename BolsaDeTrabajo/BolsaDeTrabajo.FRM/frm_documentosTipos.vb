...
Public Class frm_documentosTipos

#Region "FORMULARIO"
    Private Sub frm_documentosTipos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub BuscarTodos()
        ...
        Dim oDocumento As New cTiposDocumentos

        oDs = oDocumento.BuscarTodos
    ...
    Private Sub BuscarPorID(ByVal IdTipoDocumento As Integer)


        Dim oDs As New DataSet
        Dim oDocumento As New cTiposDocumentos

        oDs = oDocumento.BuscarPorID(IdTipoDocumento)
        txt_id.Text = oDs.Tables(0).Rows(0).Item("IdTipoDocumento")
...
#Region "FUNCIONES"
    Private Function Validar() As Boolean
        If txt_nombre.Text = "" Then
            MsgBox("Complete el nombre del Tipo de Documento", MsgBoxStyle.Exclamation, "Mensaje")
            Return False
        End If
        Return True
    End Function
        ...
        Try
            If Validar() = True Then
                ...
                If Me.Estado = EstadodelFormulario.eEditar Then
                    oDocumento.Modificar(txt_id.Text, txt_nombre.Text, chk_activo.Checked)
                    MsgBox("Se modificó correctamente el Tipo de Documento el código Nro: " + txt_id.Text, MsgBoxStyle.Information, "Exitos!")
                End If

                If Me.Estado = EstadodelFormulario.eAgregar Then
                    Dim resultado As Integer
                    resultado = oDocumento.Agregar(txt_nombre.Text, chk_activo.Checked)
                    MsgBox("Se agregó correctamente el Tipo de Documento " + txt_nombre.Text + " con el código Nro: " + resultado.ToString, MsgBoxStyle.Information, "Exitos!")
                End If
                Me.Estado = EstadodelFormulario.eConsulta
            End If
        Catch
